...
Debug views should be cheap enough to leave mounted while you work. The package keeps that true by separating material-channel views from pass-backed views.
...
| `lightComplexity` | Estimated light overlap via `NodeMaterial` override pass. |

...
description: Add shader-specific TSL node views with stable render-graph identity — native or R3F.
---
...
See [Native Runtime](/threejs-debug-view/guides/headless-runtime/) for the full frame loop.

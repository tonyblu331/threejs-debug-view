...
When you provide `viewportViews`, `DebugViews` assigns views directly to renderer viewport/scissor panes.
Use explicit panes when callers need stable pane assignment, labels, per-pane cameras, or resolution policy.

...
- `DebugViewsOptions`, layout/pane helpers, and [Native Runtime](/threejs-debug-view/guides/headless-runtime/) guide.
...
### Added
- Package logo and Starlight [R3F](/threejs-debug-view/guides/batteries-included/) guide.

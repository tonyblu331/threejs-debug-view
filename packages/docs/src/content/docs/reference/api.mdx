...
The root package export is for core helpers, planning utilities, TSL compositor helpers, and public types. The `/r3f` entrypoint contains the React Three Fiber component and Leva controls.
